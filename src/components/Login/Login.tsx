        ...
        <div className="wrapper w-full h-screen bg-white">
            <div className="content h-[410px] flex flex-col justify-between">
                ...
                <form className="form h-4/5 flex flex-col mt-2" action="/login" method="post">
                    ...
                    <div >
                        <button className='flex justify-center items-center w-full gap-x-2 bg-white hover:bg-slate-100 rounded-md p-2 mt-4' onClick={signInWithGoogle}><Image src={assets.google} alt='Google_icon' id='icon'></Image>Login with Google</button>
                    </div>
